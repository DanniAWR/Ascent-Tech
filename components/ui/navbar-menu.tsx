...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-white/[0.2] dark:bg-black dark:border-white/[0.2] bg-black shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
